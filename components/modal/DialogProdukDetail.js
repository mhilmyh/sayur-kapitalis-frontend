export const DialogProdukDetail = (props) => {
	const isActive = props.isActive || true;
	return (
		<div
			className={
				"modal pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center " +
				(isActive ? "opacity-0" : "")
			}
		>
...
export default DialogProdukDetail;
